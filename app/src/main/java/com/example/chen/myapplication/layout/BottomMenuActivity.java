...
import com.example.chen.myapplication.layout.fragment.MyFragment;
		...
		switch (checkedId){
			case R.id.rb_channel:
				if(fg1 == null){
					...
					bundle.putString("param","第一个Fragment");
					fg1 = new MyFragment();
			...
			case R.id.rb_message:
				if(fg2 == null){
					Bundle bundle = new Bundle();
					bundle.putString("param","第二个Fragment");
					fg2 = new MyFragment();
			...
			case R.id.rb_better:
				if(fg3 == null){
					Bundle bundle = new Bundle();
					bundle.putString("param","第三个Fragment");
					fg3 = new MyFragment();
			...
			case R.id.rb_setting:
				if(fg4 == null){
					Bundle bundle = new Bundle();
					bundle.putString("param","第四个Fragment");
					fg4 = new MyFragment();
